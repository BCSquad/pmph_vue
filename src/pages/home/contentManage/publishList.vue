  ...
  <el-tab-pane label="内容">
      <p class="header_p">
        ...
        <el-date-picker
          ...
          <excelExport
            class="pull-right "
            :api_export_excel="'/pmpheep/articel/exportExcel'"
    ...
    <p >
      ...
      <el-table :data="commentTableData" class="table-wrapper" @selection-change="commentSelectChange" border style="margin:15px 0;">
            ...
            <el-table-column
                ...
                >
                <template scope="scope">
                    <el-button type="text" :disabled="!scope.row.authStatus==0" @click="commentModeration(scope.row.id,5)">通过</el-button>
